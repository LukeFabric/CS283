...
1. Select with an `x` the platform you will be using for your course deliverables:
    ...
    - [ ] Orbstack on MacOs
    - [ ] VMWare Fusion
    - [x] Somthing else (put name here) Native Linux (Arch) on my own machine
...
https://github.com/LukeFabric/CS283

4. Briefly describe what you want to get out of this class.

I want to learn more about how to interact with computers on a lower level and how to program in that environment.
